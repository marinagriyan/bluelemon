...
public class PresetValueButton extends LinearLayout implements RadioCheckable {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mValueTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonValueTextColor, resources.getColor(R.color.colorAccent));
            mPressedTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonPressedTextColor, Color.WHITE);
            mUnitTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonUnitTextColor, resources.getColor(R.color.colorAccent));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void inflateView() {
        ...
        mValueTextView = findViewById(R.id.title);
        mUnitTextView = findViewById(R.id.description);
    ...
    protected void bindView() {
        ...
        if (mUnit.equals("")){
            mUnitTextView.setVisibility(GONE);
        } else {
    ...
    public void setCheckedState() {
        setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.colorBlue)));
